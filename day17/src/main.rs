...
fn solve(input: &[String]) -> (impl Display, impl Display) {
    ...
    let p2 = m
        .get_input_for_quine()
        .expect("Unable to find input to produce a quine");
...
impl Machine {
        ...
        loop {
            ...
            match instr {
                ...
                0 => {
                    ...
                    debug!("a = a / 2.pow({}) (a = {} / {})", opstr, self.a, d);
                    self.a /= d;
                }
                // BXL
                1 => {
                ...
                6 => {
                    ...
                    debug!("b = a / 2.pow({}) (a = {} / {})", opstr, self.a, d);
                    self.b = self.a / d;
                }
                // CDV
                7 => {
                    ...
                    debug!("c = a / 2.pow({}) (a = {} / {})", opstr, self.a, d);
                    self.c = self.a / d;
                }
    ...
    #[tracing::instrument(skip_all)]
    fn get_input_for_quine(&mut self) -> Option<u64> {
        None
    }
...
mod tests {
    ...
    fn test_p2(test_input: Vec<String>) {
        let mut m = parse_machine(&test_input);
        m.program = vec![0, 3, 5, 4, 3, 0];

        assert_eq!(m.get_input_for_quine(), Some(117440));
    }
